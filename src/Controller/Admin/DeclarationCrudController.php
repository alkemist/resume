    ...
    public function configureFields(string $pageName): iterable
    {
        if (Crud::PAGE_INDEX === $pageName) {
            ...
            yield ChoiceField::new('type')->setColumns(2)
                ...
                ->setFormTypeOptions(['class' => DeclarationTypeEnum::class, 'choices' => DeclarationTypeEnum::cases()]
                );
            ...
            yield ChoiceField::new('status')->setColumns(2)
                ...
                ->setFormType(EnumType::class)
                ->setFormTypeOptions(
                    ['class' => DeclarationStatusEnum::class, 'choices' => DeclarationStatusEnum::cases()]
                );
